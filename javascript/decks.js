let default_decks = [
	{
		"title": "Стандартная колода Северных Королевств, часть 1",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода Северных Королевств, часть 2",
		"description": "TBD",
		"leader": "nr_foltest_siegemaster",
		"faction": "realms",
		"cards": [
	...
	{
		"title": "Стандартная колода Нильфгаарда 1",
		"description": "TBD",
	...
	{
		"title":"Стандартная колода Нильфгаарда 2",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода монстров 1",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода монстров 2",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода Скоя'Таэль 1",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода Скоя'Таэль 2",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода Скеллиге 1",
		"description": "TBD",
	...
	{
		"title": "Стандартная колода Скеллиге 2",
		"description": "TBD",
		"leader": "sk_crach_an_craite",
		"faction": "skellige",
		"cards": [
...
var custom_decks = [
	{
		"title": "Северные Королевства - Тимерия",
		"description": "Колода Северных Королевств, ориентированная на карты Темерии — Стиль игры: Тесная Связь, Шпионы",
	...
	{
		"title": "Северные королевства - Каэдвен и Эдирн",
		"description": "Колода Северных Королевств, ориентированная на карты Каэдвена и Эдирн — Стиль игры: осадные юниты, повышение боевого духа, крепкая связь.",
		"leader": "nr_foltest_siegemaster",
		"faction": "realms",
		"cards": [
			["spe_horn", 2],
	...
	{
		"title": "Северные королевства - Цинтра и соседи",
		"description": "Колода «Северные королевства», ориентированная на Цинтру и соседние малые королевства — Стиль игры: Призыв Мстителя, Убийство Цинтры, Сбор",
	...
	{
		"title": "Северные Королевства - Редания",
		"description": "Колода Северных Королевств, ориентированная на Реданию — Стиль игры: Медик, Высокие юниты, Рог Командира",
	...
	{
		"title": "Нильфгардская империя - Армия",
		"description": "Колода Нильфгаардской империи, ориентированная на карты армий — Стиль игры: Крепкая связь, Герои, Медик, Рог",
		"leader": "ne_emhyr_relentless",
		"faction": "nilfgaard",
		"cards": [
			["spe_fog", 1],
	...
	{
		"title": "Нильфгаардская империя - знать",
		"description": "Колода Нильфгаардской империи, ориентированная на знать и аристократию — Стиль игры: Тесная связь, Шпион",
	...
	{
		"title": "Нильфгаардская империя - Вторая армия",
		"description": "Колода Империи Нильфгаарда, ориентированная на другие армейские подразделения - Стиль игры: Сбор",
	...
	{
		"title": "Монстры - Дикая Охота и Великаны",
		"description": "Колода монстров, ориентированная на дикую охоту и великанов — Стиль игры: Сбор, Высокие юниты",
		"leader": "mo_eredin_bringer_of_death",
		"faction": "monsters",
		"cards": [
			["spe_fog", 2],
	...
	},
	{
		...
		"description": "Монстры - Звери и Существа",
		"leader": "mo_eredin_commander",
		"faction": "monsters",
		"cards": [
			["spe_rain", 2],
	...
	{
		"title": "Скоя'Таэль - Коммандос",
		"description": "Колода Scoia'Tael, ориентированная на отряды коммандос - Стиль игры: Сбор, Медик",
		"leader": "sc_francesca_daisy",
		"faction": "scoiatael",
		"cards": [
			["spe_rain", 1],
	...
	{
		"title": "Скоя'Таэль - Независимые Королевства",
		"description": "Колода Скоя'Таэль, ориентированная на нечеловеческие миры, такие как Дол Блатанна, Махакам или Брокилон — Стиль игры: Сбор, Мораль",
	...
	{
		"title": "Скеллиге – Ард Скеллиг и Свальблод",
		"description": "Колода Скеллиге, основанная на картах из Ард Скеллиге и культа Свальблода — Стиль игры: Берсерк, Сбор, Крепкая связь",
		"leader": "sk_crach_an_craite",
		"faction": "skellige",
		"cards": [
			["spe_storm", 1],
	...
	{
		"title": "Скеллиге — малые острова",
		"description": "Колода Скеллиге, основанная на картах с других островов — Стиль игры: Сбор, Крепкая связь, Медик",
		"leader": "sk_king_bran",
		"faction": "skellige",
		"cards": [
			["spe_frost", 3],
	...
	{
		"title": "Школа Ведьмака — Воины и Маги",
		"description": "Колода по вселенной Ведьмака, основанная на знаменитых воинах и магах — Стиль игры: Сбор, Медик",
	...
	{
		"title": "Школа Ведьмака - Ведьмаки",
		"description": "Колода по вселенной Ведьмака, ориентированная на школы Ведьмака — Стиль игры: Школы Ведьмака, Стойкость, Ожоги",
	...
	{
		"title": "Школа Ведьмака — Демоны и Существа",
		"description": "Колода по вселенной Ведьмака, ориентированная на демонов и редких существ — Стиль игры: Сбор, Выжигание, Шпионство",
	...
	{
		"title": "Школа Ведьмака - Геральт и друзья",
		"description": "Колода по вселенной Ведьмака, ориентированная на Геральта и его друзей — Стиль игры: Сбор, Призыв Мстителя, Медик",
	...
	{
		"title": "Туссен - Рыцари и дворяне",
		"description": "Колода Туссента, ориентированная на рыцарей и дворян — Стиль игры: Тесная связь, Сбор, Высокие отряды",
	...
	{
		"title": "Лирия и Ривия - Первая линия",
		"description": "Колода Лирии и Ривии, ориентированная на карты первой линии (ближний/дальний бой) - Стиль игры: Сборщик, Медик",
	...
	{
		"title": "Лирия и Ривия - Защита",
		"description": "Колода Лирии и Ривии, ориентированная на карты тылового отряда (дальнего боя/осады) - Стиль игры: Огненный, Шпион, Медик",
	...
	{
		"title": "Синдикат - Церковь Вечного Огня",
		"description": "Колода Синдиката, основанная на картах Вечного Огня — Стиль игры: Охота на ведьм, Сбор, Димеритиум",
	...
	{
		"title": "Синдикат - Саламандра",
		"description": "Колода синдиката, основанная на картах Саламандры — Стиль игры: Сбор, Выжигание, Призыв Мстителя",
	...
	{
		"title": "Синдикат - Новиградские банды",
		"description": "Колода синдиката, основанная на картах банд Новиграда — Стиль игры: Шпион, Крепкая связь, Сбор",
	...
	{
		"title": "Зеррикания - Культ Дракона",
		"description": "Колода Зеррикания, ориентированная на драконов и их поклонников — Стиль игры: Поклонники",
	...
	{
		"title": "Армия Зеррикания",
		"description": "Колода «Зеррикания», ориентированная на боевые юниты и существа — Стиль игры: Вдохновение, Ожог, Высокие юниты",
		"leader": "ze_rarog",
		"faction": "zerrikania",
		"cards": [
			["spe_horn", 2],
